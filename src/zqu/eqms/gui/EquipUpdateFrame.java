...
public class EquipUpdateFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public EquipUpdateFrame(Object id, Object name, Object spec, Object price, Object date, Object loc,
			Object manager) {
		try {
	...
	public void Update(String id, String name, String spec, String price, String date, String loc, String manager) {
		if (name.equals("") || spec.equals("") || price.equals("") || date.equals("") || loc.equals("")
				|| manager.equals("")) {
