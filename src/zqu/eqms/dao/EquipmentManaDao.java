...
public class EquipmentManaDao {
	protected static PreparedStatement ps = null;
	protected static ResultSet rs = null;

	public static ResultSet equipmentManaQuery(String item) {
		try {
			String sql = "select e.eno, e.ename, e.espec, e.epic, e.eprice, e.edate, e.eloc, e.emanager"
					+ " from equipment e where emanager like '%" + item + "%'";
